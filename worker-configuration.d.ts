/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dde32ea5609c123842e0e75f32d11a61)
...
interface __BaseEnv_Env {
	...
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").TransferMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TransferMCP";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_TTL_SECONDS" | "MIN_TTL_SECONDS" | "MAX_TTL_SECONDS" | "MONTHLY_BUDGET_BYTES" | "ACCOUNT_ID" | "R2_BUCKET_NAME" | "R2_JURISDICTION" | "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_AUD">> {}
}
